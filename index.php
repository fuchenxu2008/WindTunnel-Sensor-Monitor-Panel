...
//             echo <<<EOT
// 		<form name='sidform' action='dashboard.php' method='POST'>
//     	   <input id='sidinput' type='hidden' name='sid' value='{$sid}'>
// 		</form>
// 		<script type='text/javascript'>document.sidform.submit();</script>
// EOT;
        }
    }
?>
            ...
            <div id="form">
                ...
                <form method="post">
                    <div class="form-item">
                        ...
                        <input type="text" name="uname" id="username" class="form-style" autocomplete="off" required/>
                    </div>
                    <div class="form-item">
                        <p class="formLabel">Password</p>
                        <input type="password" name="psw" id="password" class="form-style" required/>
